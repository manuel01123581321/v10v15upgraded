...
class resCompany(models.Model):
    ...
    quotation_expiration_days = fields.Integer('Días de expiración en cotizaciones', default=15, help="A partir de la fecha en que se crea la cotización se le sumarán estos días para obtener la fecha de caducidad de la misma.")
