...
#############################################################################
{
    "name" : "cqn_purchase_extend",
    "version" : "1.0",
    "author" : "experts.com.mx",
    "category" : "Purchase",
    "description" : """
        Módulo personalizado para compras en CQN. \n
            * Éste módulo muestra los costos del producto por sucursal en las líneas de pedidos de compras. \n
            * Perite cambiar a estado cancelado los abastecimientos que el sistema no permite de manera forzada.
    ...
    "license" : "AGPL-3",
    "depends" : ['base','purchase','experts_purchase_real_cost_by_shop','procurement','stock'],
    "demo" : [],
    "data" : [
