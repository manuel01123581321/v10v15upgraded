...
class SubstituteProducts(models.Model):
    _name = 'substitute.products'
    _rec_name = 'substitute_id'

    substitute_id = fields.Many2one('product.product',"Producto substituto")
    product_id = fields.Many2one('product.product',"Producto")
    qty = fields.Float("Cantidad disponible")
